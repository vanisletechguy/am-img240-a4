...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { City: @phone.City, name: @phone.name, number: @phone.number } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { City: @phone.City, name: @phone.name, number: @phone.number } }

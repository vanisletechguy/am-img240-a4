...
User.create(admin: true, email: 'a@a.com', password: 'hi') # id = 1
User.create(admin: false, email: 'b@b.com', password: 'hi')# id =2
User.create(admin: false, email: 'c@c.com', password: 'hi')# id =3
User.create(admin: false, email: 'd@d.com', password: 'hi')# id =4
